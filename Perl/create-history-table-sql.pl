...
#
# This script helps you to create MySQL triggers, which store changed
# records from one DB table into another *_history table. Inserted,
# changed and deleted records are archived.
#
#
